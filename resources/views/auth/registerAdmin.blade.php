...
<head>
    ...
    <title>COVAC | Admin Registration Form</title>
        ...
        <main>
            ...
            <div class="row g-3">
                <div class="col-lg-12">
                    ...
                    <form class="needs-validation" novalidate="" method="POST" action="{{ route('registerAdmin') }}">
                        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <input type="username" class="form-control @error('username') is-invalid @enderror" id="username"
                                    name="username" placeholder="ex: User123" value="{{ old('username') }}" required  autofocus>
                                @error('username')
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control @error('firstName') is-invalid @enderror"
                                    id="firstName" name="firstName" placeholder="ex: John" value="{{ old('firstName') }}"
                                    required>
                                @error('firstName')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" id="lastName" name="lastName"
                                    placeholder="ex: Douglas" value="{{ old('lastName') }}" required>
                                {{-- @error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            {{-- Staff ID --}}
                            <div class="col-12">
                                <label for="staffID" class="form-label">{{ __('Staff ID') }}</label>
                                <input type="staffID" class="form-control @error('staffID') is-invalid @enderror" id="staffID"
                                    name="staffID" placeholder="ex: ADM0000001" value="{{ old('staffID') }}" required>
                                @error('staffID')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            {{-- Healthcentre --}}
                            <div class="col-12">
                                <label for="centreName" class="form-label">{{ __('Workplace') }}</label>
                                <select type="centreName" class="form-control @error('centreName') is-invalid @enderror" id="centreName"
                                name="centreName" required>
